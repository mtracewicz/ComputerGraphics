...
QT_MOC_LITERAL(5, 34, 11), // "sendFurther"
QT_MOC_LITERAL(6, 46, 7) // "recived"

    },
    "Sliders\0valueChanged\0\0value\0color\0"
    "sendFurther\0recived"
};
...
void Sliders::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Sliders *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->valueChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< char(*)>(_a[2]))); break;
        case 1: _t->sendFurther((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Sliders::*)(int , char );
...
QT_INIT_METAOBJECT const QMetaObject Sliders::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Sliders.data,
    qt_meta_data_Sliders,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void Sliders::valueChanged(int _t1, char _t2)
{
