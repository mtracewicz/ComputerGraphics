...
# Project:  Cube.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Cube.pro
#############################################################################
...
Makefile: Cube.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents MainWidget.h Point3d.h Color.h Wall.h $(DISTDIR)/
	$(COPY_FILE) --parents Main.cpp MainWidget.cpp Point3d.cpp Color.cpp Wall.cpp $(DISTDIR)/
